...
trafficLight_1  = TrafficLight(100,  "green", 10, world.get_delta_t())
trafficLight_2  = TrafficLight(200,  "green", 27, world.get_delta_t())
trafficLight_3  = TrafficLight(500,  "green", 51, world.get_delta_t())
trafficLight_4  = TrafficLight(1000, "green", 53, world.get_delta_t())
trafficLight_5  = TrafficLight(1500, "green", 53, world.get_delta_t())
trafficLight_6  = TrafficLight(2200, "green", 61, world.get_delta_t())
trafficLight_7  = TrafficLight(2400, "green", 67, world.get_delta_t())
trafficLight_8  = TrafficLight(2600, "green", 67, world.get_delta_t())
trafficLight_9  = TrafficLight(2800, "green", 67, world.get_delta_t())
trafficLight_10 = TrafficLight(3000, "green", 57, world.get_delta_t())
trafficLight_11 = TrafficLight(5000, "green", 57, world.get_delta_t())
trafficLight_12 = TrafficLight(5100, "green", 67, world.get_delta_t())
trafficLight_13 = TrafficLight(6000, "green", 61, world.get_delta_t())
trafficLight_14 = TrafficLight(7000, "green", 61, world.get_delta_t())
trafficLight_15 = TrafficLight(8000, "green", 61, world.get_delta_t())
trafficLight_16 = TrafficLight(9900, "green", 61, world.get_delta_t())
trafficLight_17 = TrafficLight(6500, "red",   50, world.get_delta_t())
